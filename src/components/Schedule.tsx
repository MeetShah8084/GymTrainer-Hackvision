...
import { LayoutDashboard, Dumbbell, LineChart, Trophy, CalendarDays, User, Menu, X, Bell, Settings, ArrowLeft, Plus, Flame, ChevronLeft, ChevronRight } from 'lucide-react';
